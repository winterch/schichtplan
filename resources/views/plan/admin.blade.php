        ...
        @foreach($plan->shifts as $index => $shift)
            ...
            @endif
                    ...
                    @else
                      <tr class="bg-red-50">
                    @endif
                        <td class="text-sm px-4 py-4">{{$shift->type}}</td>
                        <td class="text-sm px-4 py-4">{{$shift->title}}</td>
                        <td class="text-sm px-4 py-4">{{$shift->description}}</td>
                        <td class="text-sm px-4 py-4">{{$shift->start}}</td>
                        <td class="text-sm px-4 py-4">{{$shift->end}}</td>
                        <td class="text-sm px-4 py-4">{{$shift->team_size}}</td>
                    ...
                    @endif
                        <td></td>
                            <td class="text-sm px-4 py-2">
                                <div class="border">
                                <div>
                                  <b class="px-2">{{ __('plan.subscribed') }}:</b> 
